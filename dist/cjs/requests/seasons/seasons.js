...
var getAllSeasons = function (limit) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("seasons.json?limit=".concat(limit))];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    seasonsList = response.data.MRData.SeasonTable.Seasons;
                    return [2 /*return*/, seasonsList || []];
                }
                return [2 /*return*/, []];
            case 2:
                _a = _b.sent();
...
var getAllSeasonsAdvanced = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                _d.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axiosInstance_1.default.get("".concat(advancedOptions, "seasons.json"))];
            case 2:
                response = _d.sent();
                if (response.status === 200) {
                    seasonsList = response.data.MRData.SeasonTable.Seasons;
