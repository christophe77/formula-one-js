...
var getDriverStandingsByYearRace = function (year, round) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("".concat(year, "/").concat(round, "/driverStandings.json"))];
            case 1:
                response = _b.sent();
...
var getDriverStandingsByYear = function (year, round) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("".concat(year, "/driverStandings.json"))];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists[0].DriverStandings;
...
var getCurrentDriverStanding = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("current/driverStandings.json")];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists[0].DriverStandings;
...
var getStandingsByDriver = function (driverId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("drivers/".concat(driverId, "/driverStandings.json"))];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
...
var getAllChampionshipDriverWinners = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("driverStandings/1.json?limit=1000")];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
...
var getConstructorStandingsByYear = function (year) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("".concat(year, "/constructorStandings.json"))];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists[0]
...
var getConstructorStandingsByYearRace = function (year, round) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("".concat(year, "/").concat(round, "/constructorStandings.json"))];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists[0]
...
var getCurrentConstructorStanding = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("current/constructorStandings.json")];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists[0]
...
var getAllChampionshipConstructorWinners = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("constructorStandings/1.json?limit=1000")];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists;
...
var getStandingsByConstructor = function (constructorId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axiosInstance_1.default.get("constructors/".concat(constructorId, "/constructorStandings.json"))];
            case 1:
                response = _b.sent();
                if (response.status === 200) {
                    standingsList = response.data.MRData.StandingsTable.StandingsLists;
