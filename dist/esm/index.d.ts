export declare const requests: () => {
    ...
    results: {
        getResultsByYearRace: (year: number, round: number) => Promise<import("./types/results").default | null>;
        getLatestRaceResults: () => Promise<import("./types/results").default[] | null>;
    };
    qualifyings: {
        getQualifyingsByYearRace: (year: number, round: number) => Promise<import("./types/qualifyings").default | null>;
    };
    schedule: {
